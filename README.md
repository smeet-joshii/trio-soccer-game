...
We ran it Scrum-style — 4-week sprint, kanban board, the whole thing. The full product backlog (47 tasks) is in [`docs/product-backlog.xlsx`](docs/product-backlog.xlsx) if you want to see how we broke it down.
